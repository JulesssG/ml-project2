...
\begin{itemize}
	...
	\item{Maximum and minimum of the shifted signal, shift meaning the we substract the mean}
	\item{Number of points that are above half of the max, which corresponds to the number of points with high values}
	\item{Number of points that are below half of the minimum, which corresponds to the number of points with low values}
\end{itemize}
